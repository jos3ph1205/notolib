// ==UserScript==
// @name         BoostMyExams
// @namespace    https://github.com/jos3ph1205/notolib
// @version      0.1
// @description  BoostMyExams - Because I don't have time for bullshit
// @author       jos3ph1205@github
// @match        *://*.savemyexams.com/*
// @grant        none
// @run-at       document-idle
// @updateURL    https://github.com/jos3ph1205/notolib/raw/refs/heads/main/lib/study/savemyexams/boostmyexams/boostmyexams.user.js
// @downloadURL  https://github.com/jos3ph1205/notolib/raw/refs/heads/main/lib/study/savemyexams/boostmyexams/boostmyexams.user.js
// ==/UserScript==
...
(async () => {
   ...
   if (!document.querySelector("#BoostMyExams_Style")) {
      ...
      <style id="BoostMyExams_Style">
         ...
         .boostmyexams_toast {
            ...
            &:hover {
                background-color: rgb(43, 43, 43, .9) !important;
            }   
         }
       </style>
      `;
   ...
   const injectUI = () => {
      ...
      if (downloadBtn) {
         ...
         container.insertAdjacentHTML("afterbegin", `
            <button class="btn btn-light justify-content-center dropdown-toggle boostmyexams-ui boostmyexams-downloadBtn" type="button" id="desktop-answers-dropdown" aria-expanded="false" style="display:flex;gap:.4ch;">
               Boost My Answers 
        ...
        `)
         document.querySelector(".boostmyexams-downloadBtn").onclick = () => downloadAnswers()
      }
      const courseNavMobile = document.querySelector(".CourseNavigationMobile_container__rRwbf");
      if (courseNavMobile) {
         const wrapper = document.createElement("div");
         const allTopicsBtn = courseNavMobile.querySelector("& > button")
         wrapper.className = "boostmyexams-ui"
         courseNavMobile.insertBefore(wrapper, allTopicsBtn)
         wrapper.appendChild(allTopicsBtn);
         wrapper.insertAdjacentHTML("afterbegin", `
            <button class="btn btn-primary btn-lg justify-content-center my-2 me-2 overflow-hidden boostmyexams_refreshBtn">
               <span class="Button_icon__6so9o CourseNavigationMobile_icon__qeiVZ me-2">
            ...
            <button class="btn btn-primary btn-lg justify-content-center my-2 me-2 overflow-hidden boostmyexams_infoBtn">
               <span class="Button_icon__6so9o CourseNavigationMobile_icon__qeiVZ me-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                     fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      if (courseNavDesktop) {
         courseNavDesktop.insertAdjacentHTML("beforeend", `
            ...
            <button aria-label="Mock Exams" title="Refresh BoostMyExams"
               class="btn justify-content-center btn-primary ButtonIcon_large__4yD66 ButtonIcon_rounded__TLKY_ ButtonIcon_button__8mJq7 boostmyexams boostmyexams-ui boostmyexams_refreshBtn">
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                  fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8"/>
                  <path d="M21 3v5h-5"/>
            ...
            <button aria-label="Boost Info" title="Show BoostMyExams Info"
               class="btn justify-content-center btn-neutral ButtonIcon_large__4yD66 ButtonIcon_rounded__TLKY_ ButtonIcon_button__8mJq7 boostmyexams boostmyexams-ui boostmyexams_infoBtn">
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                  fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <circle cx="12" cy="12" r="10"/>
                  <path d="M12 16v-4"/><path d="M12 8h.01"/>
      ...
      if (courseNavDesktop || courseNavMobile) {
   ...
   const observer = new MutationObserver(() => {
      if (!document.querySelector(".boostmyexams-ui")) {
         injectUI();
      }
   });
   ...
   async function downloadAnswers () {
      ...
      const captureAndZipAnswers = async () => {
         ...
         const topic = document.querySelector(".questions_title__ePEn5").textContent.replace(/\s/gi, "-");
         for (const [i, btn] of [...questionBtns].entries()) {
            ...
            const canvas = await html2canvas(modal, { backgroundColor: "#000" });
         ...
         link.download = `${topic.toLowerCase()}-answers.zip`;
         link.click();
